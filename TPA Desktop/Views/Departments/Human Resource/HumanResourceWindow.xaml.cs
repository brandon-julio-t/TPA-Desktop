...
using TPA_Desktop.Views.Departments.Human_Resource.Employees;
using TPA_Desktop.Views.Departments.Human_Resource.Violations;

namespace TPA_Desktop.Views.Departments.Human_Resource
{
